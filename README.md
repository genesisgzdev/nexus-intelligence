...
class BenfordAnalyzer:
    ...
    def get_first_digit(cls, v: float) -> int:
        # Pure mathematical extraction prevents scientific notation errors
        if v == 0: return 0
        v = abs(v)
