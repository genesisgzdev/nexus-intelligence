...
La correlación es una matriz TF-IDF reproducible. No depende de FAISS, de embeddings remotos ni de una API de inteligencia externa. La configuración no ofrece proxy, DoH ni CT externo: las únicas consultas salen por los resolvers DNS configurados y por los módulos de observación autorizados.
